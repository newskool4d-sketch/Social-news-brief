...
# 2026-07-30 커버리지 균형 보정: 공백 과목(정치·금융과 경제생활·사회문제 탐구) 각도의
# 시딩 검색어 추가 — 지방자치(정치 제도), 금융 소비자(생활금융), 사회조사(탐구·통계 프레임).
AXIS_QUERIES = {
    "정치·행정": ["국회 법안", "정부 정책 발표", "지방자치"],
    "법·사법": ["대법원 판결", "헌법재판소 결정"],
    "경제·금융": ["한국은행 기준금리", "통계청 발표", "금융 소비자 보호"],
    "사회·문화": ["사회 갈등", "저출산 고령화", "사회조사 결과"],
    "국제관계": ["국제 분쟁", "외교 협상"],
}
